...
namespace CbtXamarin.helpers
{
    public class Quizhelpers
    {
        ...
        public string GetTopicDescription(string topic)
        {
            ...
            if (topic == "History")
            {
                topicDescription = "History is the study of past events"; 
            }
            else if (topic == "Geography")
            {
                topicDescription = "Geography is the study of earth";
            }
            else if (topic == "Space")
            {
                topicDescription = "space is the study of the atmosphere";
            }
            else if (topic == "Engineering")
            {
                topicDescription = "Engineering is the study of mechcanical parts";
            }
            if (topic == "Programing")
            {
                topicDescription = "Programing is the development of applications using codes";
            }
            if (topic == "Business")
            {
                topicDescription = "Business is the study of finance";
            }
