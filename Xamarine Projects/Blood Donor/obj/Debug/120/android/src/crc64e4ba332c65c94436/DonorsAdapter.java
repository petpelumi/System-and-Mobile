...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Blood_Donor.Adapters.DonorsAdapter, Blood Donor", DonorsAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == DonorsAdapter.class)
			mono.android.TypeManager.Activate ("Blood_Donor.Adapters.DonorsAdapter, Blood Donor", "", this, new java.lang.Object[] {  });
	}
